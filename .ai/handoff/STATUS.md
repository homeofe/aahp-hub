...
- 2026-07-24: security & ui: resolved security advisories (sharp ^0.35.3 override), merged dependabot PR (actions/checkout@v7), enabled main branch protection on GitHub repo, synced AAHP v3.8.1 manifest scripts, added turbopack.root to next.config.ts, and redesigned WebUI with ProjectExplorer (Grid, Compact, and Ultra-dense Table views, multi-facet search/filters, pagination, localStorage options).
